...
//     fun activateAccount(@RequestBody request: ActivateAccountRequest): ResponseEntity<Any> {
...
//     fun getUserInfo(@AuthenticationPrincipal userDetails: UserDetails): ResponseEntity<Any> {
